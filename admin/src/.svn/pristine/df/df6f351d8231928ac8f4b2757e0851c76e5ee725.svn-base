<template>
    <el-dialog :title="title" size='small' :visible.sync="dialogVisible" @close="closeDialog">
        <el-row>
            <el-col :span="23">
                <el-form :model="form" ref="form" :rules="rules" label-suffix='：'>
                    ...
                    <el-form-item v-if="!id" label="邮箱" :label-width="formLabelWidth" required prop="email">
        ...
        <div slot="footer" class="dialog-footer">
            <el-button type="primary" size="large" :loading="loadingBiao" v-if="authCheck(120)&&authCheck(121)" @click="onSubmit">确定保存</el-button>
        </div>
    </el-dialog>
</template>
