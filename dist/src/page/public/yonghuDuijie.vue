<template>
    <el-dialog :title="title" :visible.sync="dialogFormVisibles" size="tiny" class="qiye-duijie" :before-close="closeDialog">
        <el-form :model="form" :rules="rules" ref="form">
            <el-form-item :label="label" :label-width="formLabelWidth" prop="name" required>
            ...
            <el-form-item label="对接诉求" :label-width="formLabelWidth" prop="docking" required>
            ...
            <el-form-item label="" :label-width="formLabelWidth" prop="content" required>
            ...
            <el-form-item label="" :label-width="formLabelWidth">
                ...
                <QN_upload type="default" button_text='请上传压缩包或PDF格式 10M以内' keyPrefix="file" :filters="filtersVideo" max_file_size="10mb" @Callback-UploadProgress.self="CB_UploadProgress_video" @Callback-GetFileUrl.self="CB_GetFileUrl_video" @Callback-Error.self="CB_Error_video">
                </QN_upload>
