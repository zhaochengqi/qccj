        ...
        <el-row :gutter="50" class="">
            <el-col :xs="8" :sm="8" :md="8" :lg="8">
                <div class="xiangqing-img">
                    <img :src="detailData.img?detailData.img +'!308x417':'./static/img/default.jpg'" alt="">
                </div>
            </el-col>
            <el-col :xs="16" :sm="16" :md="16" :lg="16">
                <div class="zhuanti-txt">
                    <h4 class="font-120 no-margin margin-bottom-10 aui-ellipsis-1">{{detailData.name}}</h4>
                    <h4 class="font-120 no-margin margin-bottom-30 aui-ellipsis-1">{{detailData.zhiwei}}</h4>
