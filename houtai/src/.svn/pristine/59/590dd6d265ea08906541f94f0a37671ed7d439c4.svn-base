        ...
        <el-row :style="{ 'min-height': _PageHeight+30+'px'}">
            <el-form ref="form" :model="form" :rules="rules" label-width="100px">
                ...
                <el-form-item label="链接地址">
                    <el-col :md="16">
                        <el-input placeholder="请填写专题链接地址" @keyup.enter.native="onSubmit" v-model="form.link">
                            <template slot="prepend">http://</template>
                        </el-input>
                    </el-col>
                </el-form-item>
                <el-form-item>
                    <el-button type="primary" v-if="authCheck(84)||authCheck(86)" size="large" :loading="vloading" @click="onSubmit">保存精彩专题</el-button>
                </el-form-item>
            </el-form>
        </el-row>
    </el-card>
