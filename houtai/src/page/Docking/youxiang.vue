<template>
    <el-dialog title="通知邮箱" :visible.sync="dialogFormVisible" v-loading="loading" element-loading-text="拼命加载中" close-on-press-escape @close="cleardialog">
        <el-form :model="form" :rules="rules" label-width="120px" ref="form" onsubmit="return false;">
            <el-row>
                <el-form-item label="通知邮箱" required prop="inputValue">
                    <el-col :md="18" v-model="form.email">
                        ...
                        <el-input class="input-new-tag" v-if="inputVisible" v-model="form.inputValue" ref="saveTagInput" size="mini" @keyup.enter.native="handleInputConfirm" @blur="handleInputConfirm">
                        </el-input>
                ...
                <el-row>
                    <el-radio-group v-model="form.intervals" style="margin-top:3px;width:400px;">
                        <el-col :md="8" class="padding-5">
                        ...
                        <el-col :md="8" class="padding-5">
                            <el-radio :label="4" >每天早上8点</el-radio>
                        </el-col>
                        <el-col :md="8" class="padding-5">
    ...
    methods: {
        ...
        handleInputConfirm() {
            if (this.form.inputValue) {
                ...
                if(!reg.test(this.form.inputValue)){
            　　　　this.form.inputValue=''
                 }else{
                    this.dynamicTags.push(this.form.inputValue);
                 }
            }
