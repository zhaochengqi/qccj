                ...
                <el-col :xs="24" :sm="6" :md="6" :lg="6">
                    <div class="zl-zuozhe">
                        <div class="zuozhe-img">
                            <img v-else :src="nameData.img?nameData.img+'!175x160':'./static/img/default.jpg'" style="cursor:pointer" @click="chakan(nameData.id)">
                        </div>
                        ...
                        <el-col :xs="24" :sm="13" :md="13" :lg="13">
                            <div class="zhuanlan-list-img index-img-big">
                                <a :href="url+item.id" target="_Blank">
                                    <img v-else :src="item.img?item.img:'./static/img/default.jpg'" alt="">
                                </a>
                            </div>
